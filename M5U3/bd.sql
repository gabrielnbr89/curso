...
-- Tiempo de generación: 31-07-2022 a las 02:27:30
...
--
CREATE DATABASE IF NOT EXISTS `ejercicio` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ejercicio`;
...
(23, 'Juan', 'Lopez', 'Programador', 33, 93000, 'jl@bignet.com');
